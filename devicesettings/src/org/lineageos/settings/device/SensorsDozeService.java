...
public class SensorsDozeService extends Service {
    ...
    private PickUpSensor.PickUpListener mPickUpListener =
        ...
        public void onEvent() {
            ...
            Log.i("PICKUP SDS", "onEvent() with mPickUpState = " + mPickUpState);
            handlePickUp();
        }
        public void onInit() {
            mPickUpState = mPickUpSensor.isPickedUp();
    ...
    private void handleProximity(long timestamp) {
        ...
        if (!mProximityNear) {
            Log.i("PICKUP SENSOR", "in handleProximity(), proximity released");
            mHandwaveDoze = false;
            mPickUpDoze = false;
            mPocketDoze = false;
    ...
    private void handlePickUp() {
        ...
        Log.i("PICKUP SDS:", "handling event");
    ...
    private void analyseDoze() {
        ...
        // Pick-up Doze launch
            ...
            Log.i("PICKUP SDS", "launchDozePulse");
            launchDozePulse();
        }
        // Pocket Doze launch
